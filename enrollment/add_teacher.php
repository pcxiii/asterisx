...
<form class="">
    <div class='col-md-8'>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <input type="text" class="form-control" id="tmname">
        </div>  
       ...
       <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="estat">
        </div>  
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <select name="" id="cstatus" class="form-control">
      ...
      <option value="">Widow</option>
         ...
         <div class='col-md-8'>
          ...
          <span class="glyphicon glyphicon-floppy-disk"></span> Saved
          </a>  
